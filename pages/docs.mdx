...
```
<iframe src="https://reliable.vercel.app/embed/SITE_ID" />
```
...
```
<iframe src="https://reliable.vercel.app/embed/SITE_ID/ROUTE" />
```
...
<IframeResizer
  checkOrigin={false}
  title="Comments"
  src={`https://reliable.vercel.app/embed/SITE_ID`}
  style={{
    width: '1px',
    minWidth: '100%'
  }}
...
function Feedback () {
  const API = 'https://reliable.vercel.app/api/feedback/SITE_ID';
